...
import com.kenshuchong.MongodbSink.vo.ZccVO;
  ...
  public Status process() throws EventDeliveryException {
    ...
    try {
      ...
      for (count = 0; count < batchSize; ++count) {
        ...
        Document sentEvent = new Document().append("Dir","/data/ngnix.log").append("Time", cuTime);
        ZccVO zcc=JSONObject.parseObject(jsonEvent, ZccVO.class);
        sentEvent.append("name",zcc.getName());
        sentEvent.append("name2",zcc.getName2());
        sentEvent.append("name3",zcc.getName3());
        sentEvent.append("name4",zcc.getName4());
        sentEvent.append("name5",zcc.getName5());
